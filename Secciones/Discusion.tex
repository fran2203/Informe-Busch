...
las mismas condiciones de corriente $I$ y resistencias de los reóstatos, el valor cambiaba en ciertos puntos, provocando una gran variación de campo a lo largo del cilindro. En un primer
...
Una posible explicación es que haya cambiado el valor de resistencia de alguna de las bobinas, lo que haría que cambie el
valor de $I$ y por tanto de $B,$ aunque no hay una total certeza de esto.
