...
para distintos valores de tensión de aceleración $V.$ Se muestra en la Figura \ref{fig:area_impacto} cómo la variación de tensión de alimentación (y por tanto de campo magnético)
...
Para cada valor de tensión de aceleración, se graficó el área relativa en función de la tensión de alimentación,
...
Se observa una curva que comienza con un área máxima de impacto para luego reducirse progresivamente, con unos mínimos relativos entre medio, aunque esto no fue totalmente así
para otros valores de tensión de aceleración, sino que luego de un mínimo algunas curvan aumentaban mucho su área de impacto. El porqué de esto se discutirá más adelante.
...
Para cada orden de mínimos, la relación debería ser lineal, pero se observa que sólo algunos ordenes cumplen esto, lo que es inconsistente
...
A partir de la pendiente del ajuste y la Ecuación \ref{eq:Busch}, se determinó que la relación
carga-masa del electrón es $e/m=\left( 6,7 \pm 0,4 \right)\times 10^{11}\,\unit{\coulomb\per\kilogram}.$ El valor aceptado correspondiente resulta: $1,75882000838(55)\times 10^{11}\,\unit{\coulomb\per\kilogram}$\cite{nist_em}, alejado del reportado experimentalmente en, aproximadamente, 12 sigmas, pero con el mismo orden de magnitud.
...
lejano del aceptado, aunque mejor que el obtenido anteriormente (distante en, aproximadamente, 7 sigmas).